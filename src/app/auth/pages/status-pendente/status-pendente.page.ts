...
@Component({
  selector: 'app-status-pendente',
  templateUrl: './status-pendente.page.html',
  styleUrls: ['./status-pendente.page.scss'],
})
export class StatusPendentePage implements OnInit, OnDestroy, AfterViewInit {
  private loading: any;
