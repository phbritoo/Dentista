...
@Component({
  selector: 'app-editar-pedido-prot',
  templateUrl: './editar-pedido-prot.page.html',
  styleUrls: ['./editar-pedido-prot.page.scss']
})
export class EditarPedidoProtPage implements OnInit, OnDestroy {
  ...
  async atualizarPedido() {
    ...
    this.navCtrl.navigateBack(['/home-protetico']);
  }
