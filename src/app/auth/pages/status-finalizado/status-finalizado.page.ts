...
@Component({
  selector: 'app-status-finalizado',
  templateUrl: './status-finalizado.page.html',
  styleUrls: ['./status-finalizado.page.scss'],
})
export class StatusFinalizadoPage implements OnInit, OnDestroy, AfterViewInit {
  private loading: any;
