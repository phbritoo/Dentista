...
@Component({
  selector: 'app-status-fabricacao',
  templateUrl: './status-fabricacao.page.html',
  styleUrls: ['./status-fabricacao.page.scss'],
})
export class StatusFabricacaoPage implements OnInit, OnDestroy, AfterViewInit {
  private loading: any;
